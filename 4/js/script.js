...
class FullPageScroll {
  constructor() {
    ...
    this.screenTransition = document.querySelector(`.screen-transition`);
  ...
  onUrlHashChanged() {
    ...
    if (this.activeScreen === 1 && newIndex === 2) {
      this.screenTransition.classList.add(`show`);
      setTimeout(() => {
        this.screenTransition.classList.remove(`show`);
